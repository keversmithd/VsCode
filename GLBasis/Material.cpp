...
#pragma region Shaders
    ...
    int error = 0;
    NGLProgram nglProgram = CreateShader(WS "shaders/material.vs", WS "shaders/material.fs");
...
#pragma endregion
    ...
    glm::vec3 ambient = glm::vec3(1.0f, 0.5f, 0.31f), diffuse = glm::vec3(1.0f, 0.5f, 0.31f), specular = glm::vec3(0.5f, 0.5f, 0.5f);
...
#pragma endregion
        ...
        setVec3(nglProgram,"material.ambient", ambient);
        setVec3(nglProgram,"material.diffuse", diffuse);
        setVec3(nglProgram,"material.specular", specular);
        setFloat(nglProgram,"material.shininess", shininess);
        ...
        ImGui_ImplGlfwGL3_NewFrame();
            {
                ...
                ImGui::SliderFloat3("ambient", glm::value_ptr(ambient),0, 2);
                ImGui::SliderFloat3("diffuse", glm::value_ptr(diffuse),0, 2);
                ImGui::SliderFloat3("specular", glm::value_ptr(specular),0, 2);
