#ifndef LTX_EXPANDED_CURVE_LIST_H
#define LTX_EXPANDED_CURVE_LIST_H
...
struct CurveList
{
    ...
    //need to know
    //number of curves in this current main curvature
    //bounding area of the independant curve, plus bounding area of a layered curve
    ...
    void startCurveAtNormalizedBoxCoordinate(LTXPoint normalizedCoordinate)
    {
        //option use the quad tree to find the nearest curve to the point
        LTXPoint denormalized = normalizedCoordinate*BoundingArea;
    }
